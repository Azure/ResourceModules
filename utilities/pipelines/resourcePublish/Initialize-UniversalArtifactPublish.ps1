...
.EXAMPLE
Initialize-UniversalArtifactPublish -moduleName 'keyvault' -vstsOrganization 'servicescode' -vstsProject '$(System.TeamProject)' -vstsFeedName 'Modules' -customVersion '3.0.0'
...
.EXAMPLE
Initialize-UniversalArtifactPublish -moduleName 'keyvault' -vstsOrganization 'servicescode' -vstsProject '$(System.TeamProject)' -vstsFeedName 'Modules' -customVersion '1.0.0'
...
.EXAMPLE
Initialize-UniversalArtifactPublish -moduleName 'keyvault' -vstsOrganization 'servicescode' -vstsProject '$(System.TeamProject)' -vstsFeedName 'Modules'
...
function Initialize-UniversalArtifactPublish {
    ...
    process {
        ...
        try {
            ...
            $url = "https://feeds.dev.azure.com/$vstsOrganization/$vstsProject/_apis/packaging/Feeds/$vstsFeedName/packages?packageNameQuery=$lowerModuleName&api-version=6.0-preview"
