...
.EXAMPLE
Get-ModulesMissingFromUniversalArtifactsFeed -TemplateFilePath 'C:\modules\Microsoft.KeyVault\vaults\main.bicep' -vstsOrganizationUri 'https://dev.azure.com/fabrikam' -VstsProject 'IaC' -VstsFeedName 'Artifacts'
...
----                           -----
Version                        0.4.0
TemplateFilePath               C:\ResourceModules\modules\Microsoft.KeyVault\vaults\accessPolicies\main.bicep
Version                        0.4.0
TemplateFilePath               C:\ResourceModules\modules\Microsoft.KeyVault\vaults\keys\main.bicep
Version                        0.4.0
TemplateFilePath               C:\ResourceModules\modules\Microsoft.KeyVault\vaults\secrets\main.bicep
Version                        0.5.0
TemplateFilePath               C:\ResourceModules\modules\Microsoft.KeyVault\vaults\main.bicep
#>
function Get-ModulesMissingFromUniversalArtifactsFeed {
    ...
    process {
        # Get all children
        $availableModuleTemplatePaths = (Get-ChildItem -Path (Split-Path $TemplateFilePath) -Recurse -Include @('main.bicep', 'deploy.json')).FullName
