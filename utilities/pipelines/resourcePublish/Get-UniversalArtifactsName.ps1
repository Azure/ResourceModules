...
.EXAMPLE
Get-UniversalArtifactsName -TemplateFilePath 'C:\modules\Microsoft.KeyVault\vaults\main.bicep'

Convert 'C:\modules\Microsoft.KeyVault\vaults\main.bicep' to e.g. 'microsoft.keyvault.vaults'
#>
