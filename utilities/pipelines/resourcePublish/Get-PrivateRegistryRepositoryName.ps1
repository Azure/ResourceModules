...
.EXAMPLE
Get-PrivateRegistryRepositoryName -TemplateFilePath 'C:\modules\Microsoft.KeyVault\vaults\main.bicep'

Convert 'C:\modules\Microsoft.KeyVault\vaults\main.bicep' to e.g. 'bicep/modules/microsoft.keyvault.vaults'
#>
