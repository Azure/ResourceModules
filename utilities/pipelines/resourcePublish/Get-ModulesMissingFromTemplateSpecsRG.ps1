...
.EXAMPLE
Get-ModulesMissingFromTemplateSpecsRG -TemplateFilePath 'C:\ResourceModules\modules\Microsoft.KeyVault\vaults\main.bicep' -TemplateSpecsRGName 'artifacts-rg'
