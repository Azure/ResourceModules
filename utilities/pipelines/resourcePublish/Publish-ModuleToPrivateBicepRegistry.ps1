...
.EXAMPLE
Publish-ModuleToPrivateBicepRegistry -TemplateFilePath 'C:\modules\KeyVault\vaults\main.bicep' -ModuleVersion '3.0.0-alpha' -BicepRegistryName 'adpsxxazacrx001' -BicepRegistryRgName 'artifacts-rg'
