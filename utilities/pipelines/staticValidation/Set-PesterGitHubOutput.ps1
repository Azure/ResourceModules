...
@{
    ...
    FailedBlocks          = ''
    FailedContainers      = ''
    Passed                = '[+] [Microsoft.KeyVault/vaults/secrets] Module should contain a [deploy.json/main.bicep] file. [+] ...'
    NotRun                = ''
    Tests                 = '[+] [Microsoft.KeyVault/vaults/secrets] Module should contain a [deploy.json/main.bicep] file. [+] ...'
    CodeCoverage          = null
}
