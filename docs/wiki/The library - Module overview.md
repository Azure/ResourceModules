...
| # | Module | RBAC | Locks | Tags | Diag | EP | Pip-Depl. | # children | # lines |
| - | - | - | - | - | - | - | - | - | - |
...
| `EP` | Whether the module can deploy _Private Endpoints_. |
| `Pip-Depl.` | Whether the module can deploy a _Public IP_ as a secondary resource. |
...
| `# lines` | The number of lines in the given module. |
