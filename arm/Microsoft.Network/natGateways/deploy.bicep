...
resource publicIP_locks 'Microsoft.Authorization/locks@2017-04-01' = [for lock in locks: {
...
resource natGateway_locks 'Microsoft.Authorization/locks@2017-04-01' = [for lock in locks: {
