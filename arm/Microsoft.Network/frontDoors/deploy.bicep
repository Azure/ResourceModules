...
resource frontDoor_locks 'Microsoft.Authorization/locks@2017-04-01' = [for lock in locks: {
...
module frontDoor_rbac '.bicep/nested_rbac.bicep' = [for (roleAssignment, index) in roleAssignments: {
