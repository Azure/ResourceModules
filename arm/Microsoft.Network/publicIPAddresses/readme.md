...
| :-- | :-- | :-- |
| `name` | string | The name of the public IP adress |
| `resourceGroupName` | string | The resource group the public IP adress was deployed into |
| `resourceId` | string | The resource ID of the public IP adress |
