...
resource publicIpPrefix 'Microsoft.Network/publicIPPrefixes@2021-02-01' existing = {
  name: resourceName
}
...
resource roleAssignment 'Microsoft.Authorization/roleAssignments@2020-04-01-preview' = [for principalId in roleAssignmentObj.principalIds: {
  name: guid(publicIpPrefix.name, principalId, roleAssignmentObj.roleDefinitionIdOrName)
  properties: {
