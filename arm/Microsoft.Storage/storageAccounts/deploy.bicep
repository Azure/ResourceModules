...
output storageAccountPrimaryBlobEndpoint string = !empty(blobServices) ? reference('Microsoft.Storage/storageAccounts/${storageAccount.name}', '2019-04-01').primaryEndpoints.blob : ''
