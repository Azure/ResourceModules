...
| `diagnosticSettings`                           | array  | Optional. Set the storage account, workspace or eventhub to send metrics or logs.                                                                                                                                                                                                                                                                                                                               | System.Object[]            |                 |
...
### Parameters usage: `diagnosticSettings`
    ...
    "value": [
        {
          "name": "service",
          "properties": {
            "storageAccountId":"<storage account resourceId>",
            "workspaceId":"<workspace  resourceId>",
            "eventHubName":"<Name of the event hub within the namespace to which logs are streamed. Without this, an event hub is created for each log category.>",
            "eventHubAuthorizationRuleId":"Resource ID of the event hub authorization rule for the Event Hubs namespace in which the event hub should be created or streamed to.",
            "metrics": [
              {
                "category": "AllMetrics",
                "timeGrain": null,
