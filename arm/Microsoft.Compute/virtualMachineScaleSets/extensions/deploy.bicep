@description('Conditional. The name of the virtual machine scale set that extension is provisioned for. Required if the template is used in an standalone deployment.')
