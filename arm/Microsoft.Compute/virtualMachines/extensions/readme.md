...
| Parameter Name | Type | Description |
| :-- | :-- | :-- |
| `virtualMachineName` | string | The name of the virtual machine that extension is provisioned for. Required if the template is used in an standalone deployment. |
