...
| :-- | :-- | :-- | :-- |
| `primaryUserAssignedIdentityId` | string | `''` | Requried if "userAssignedIdentities" is not empty. The resource ID of a user assigned identity to be used by default. |
