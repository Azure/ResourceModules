...
| `cpuCores` | int | Optional. The number of CPU cores to allocate to the container. | 1.0 |  |
...
| `memoryInGB` | int | Optional. The amount of memory to allocate to the container in gigabytes. | 1.5 |  |
