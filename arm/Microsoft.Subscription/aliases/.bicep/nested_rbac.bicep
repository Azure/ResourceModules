...
@sys.description('Required. The Principal or Object IDs of the Security Principals (User, Group, Service Principal, Managed Identity)')
param principalIds array

@sys.description('Required. Subscription ID of the subscription to assign the RBAC role to. If not provided, will use the current scope for deployment.')
...
var builtInRoleNames = {
  ...
  'Azure Connected SQL Server Onboarding': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'e8113dce-c529-4d33-91fa-e9b972617508')
  ...
  'Azure Spring Cloud Config Server Reader': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'd04c6db6-4947-4782-9e91-30a88feb7be7')
  ...
  'Azure Spring Cloud Service Registry Contributor': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'f5880b48-c26d-48be-b172-7927bfa1c8f1')
  'Azure Spring Cloud Service Registry Reader': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'cff1b556-2399-4e7e-856d-a8f754be7b65')
  ...
  'Azure VM Managed identities restore Contributor': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '6ae96244-5829-4925-a7d3-5975537d91dd')
  ...
  'Device Provisioning Service Data Contributor': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'dfce44e4-17b7-4bd1-a6d1-04996ec95633')
  'Device Provisioning Service Data Reader': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '10745317-c249-44a1-a5ce-3a4353c0bbd8')
  ...
  'Experimentation Metric Contributor': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '6188b7c9-7d01-4f99-a59f-c88b630326c0')
  ...
  'IoT Hub Data Reader': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'b447c946-2db7-41ec-983d-d8bf3b1c77e3')
  'IoT Hub Registry Contributor': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '4ea46cd5-c1b2-4a8e-910b-273211f9ce47')
  'IoT Hub Twin Contributor': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '494bdba2-168f-4f31-a0a1-191d2f7c028c')
  ...
  'Managed Services Registration assignment Delete Role': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '91c1777a-f3dc-4fae-b103-61d183457e46')
  ...
  'Microsoft.Kubernetes connected cluster role': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '5548b2cf-c94c-4228-90ba-30851930a12f')
  ...
  'Object Anchors Account Owner': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'ca0835dd-bacc-42dd-8ed2-ed5e7230d15b')
  'Object Anchors Account Reader': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '4a167cdf-cb95-4554-9203-2347fe489bd9')
  ...
  'Object Understanding Account Reader': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'd18777c0-1514-4662-8490-608db7d334b6')
  ...
  'Project Babylon Data Curator': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '9ef4ef9c-a049-46b0-82ab-dd8ac094c889')
  'Project Babylon Data Reader': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'c8d896ba-346d-4f50-bc1d-7d1c84130446')
  'Project Babylon Data Source Administrator': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '05b7651b-dc44-475e-b74d-df3db49fae0f')
  ...
  'Security Detonation Chamber Publisher': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '352470b3-6a9c-4686-b503-35deb827e500')
  'Security Detonation Chamber Reader': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '28241645-39f8-410b-ad48-87863e2951d5')
  'Security Detonation Chamber Submission Manager': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'a37b566d-3efa-4beb-a2f2-698963fa42ce')
  'Security Detonation Chamber Submitter': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '0b555d9b-b4a7-4f43-b330-627f0e5be8f0')
  ...
  'Stream Analytics Query Tester': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '1ec5b3c1-b17e-4e25-8312-2acb3c3c5abf')
  ...
  'Test Base Reader': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '15e0f5a1-3450-4248-8e25-e2afe88a9e85')
  ...
  'WorkloadBuilder Migration Agent Role': subscriptionResourceId('Microsoft.Authorization/roleDefinitions', 'd17ce0a2-0697-43bc-aac5-9113337ab61c')
}

resource roleAssignment 'Microsoft.Authorization/roleAssignments@2021-04-01-preview' = [for principalId in principalIds: {
  name: guid(last(split(subscriptionId, '/')), principalId, roleDefinitionIdOrName)
  properties: {
