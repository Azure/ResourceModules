...
resource privateDnsZoneGroups 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2017-04-01' = if (!empty(privateEndpoint_var.privateDnsZoneResourceIds)) {
