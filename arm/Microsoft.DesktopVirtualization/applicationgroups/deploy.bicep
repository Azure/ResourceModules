...
resource appGroupName_resource 'Microsoft.DesktopVirtualization/applicationgroups@2020-11-02-preview' = {
  name: appGroupName
  location: location
  tags: tags
  properties: {
...
resource appGroupName_Microsoft_Authorization_hostPoolDoNotDelete 'Microsoft.DesktopVirtualization/applicationgroups/providers/locks@2016-09-01' = if (lockForDeletion) {
  name: '${appGroupName}/Microsoft.Authorization/hostPoolDoNotDelete'
  properties: {
    level: 'CannotDelete'
  }
  dependsOn: [
...
resource appGroupName_Microsoft_Insights_service 'Microsoft.DesktopVirtualization/applicationgroups/providers/diagnosticsettings@2017-05-01-preview' = if ((!empty(diagnosticStorageAccountId)) || (!empty(workspaceId)) || (!empty(eventHubAuthorizationRuleId)) || (!empty(eventHubName))) {
  name: '${appGroupName}/Microsoft.Insights/service'
  location: location
  properties: {
...
output appGroupResourceId string = appGroupName_resource.id
