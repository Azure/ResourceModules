@description('Conditional. Name of the parent Service Bus Namespace for the Service Bus Topic. Required if the template is used in a standalone deployment.')
@minLength(6)
@maxLength(50)
