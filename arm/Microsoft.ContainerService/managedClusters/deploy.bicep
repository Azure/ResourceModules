...
var builtInRoleNames = {
  ...
  'Azure Kubernetes Service RBAC Admin': '/subscriptions/${subscription().subscriptionId}/providers/Microsoft.Authorization/roleDefinitions/3498e952-d568-435e-9b2c-8d77e338d7f7'
  'Azure Kubernetes Service RBAC Cluster Admin': '/subscriptions/${subscription().subscriptionId}/providers/Microsoft.Authorization/roleDefinitions/b1ff04bb-8a4e-4dc4-8eb5-8693973ce19b'
  'Azure Kubernetes Service RBAC Reader': '/subscriptions/${subscription().subscriptionId}/providers/Microsoft.Authorization/roleDefinitions/7f6c6a51-bcf8-42ba-9220-52d62157d7db'
  'Azure Kubernetes Service RBAC Writer': '/subscriptions/${subscription().subscriptionId}/providers/Microsoft.Authorization/roleDefinitions/a7ffa36f-339b-4b5c-8bdf-e2c188b2c0eb'
...
resource managedCluster_lock 'Microsoft.Authorization/locks@2016-09-01' = if (lockForDeletion) {
  name: '${managedCluster.name}-doNotDelete'
  properties: {
    level: 'CanNotDelete'
  }
