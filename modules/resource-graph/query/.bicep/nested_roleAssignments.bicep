...
resource resourceGraphQuery 'Microsoft.ResourceGraph/queries@2018-09-01-preview' existing = {
  name: last(split(resourceId, '/'))!
}

resource roleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = [for principalId in principalIds: {
  name: guid(resourceGraphQuery.id, principalId, roleDefinitionIdOrName)
  properties: {
