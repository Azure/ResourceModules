...
| `Microsoft.EventGrid/domains/topics` | [2022-06-15](https://docs.microsoft.com/en-us/azure/templates/Microsoft.EventGrid/2022-06-15/domains/topics) |
...
```bicep
module domainTopics './Microsoft.EventGrid/domainTopics/deploy.bicep' = {
  name: '${uniqueString(deployment().name, location)}-test-egdtmin'
  params: {
    // Required parameters
    domainName: '<domainName>'
    name: '<<namePrefix>>egdtmin001'
