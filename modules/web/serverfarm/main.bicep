...
@description('Conditional. Defaults to false when creating Windows/app App Service Plan. Required to be set to true when creating a Linux App Service Plan.')
