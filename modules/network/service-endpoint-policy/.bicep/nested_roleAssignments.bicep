...
resource serviceEndpointPolicy 'Microsoft.Network/serviceEndpointPolicies@2023-04-01' existing = {
  name: last(split(resourceId, '/'))!
}

resource roleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = [for principalId in principalIds: {
  name: guid(serviceEndpointPolicy.id, principalId, roleDefinitionIdOrName)
  properties: {
