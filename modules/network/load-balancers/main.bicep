...
module loadBalancer_backendAddressPools 'backend-address-pools/main.bicep' = [for (backendAddressPool, index) in backendAddressPools: {
...
module loadBalancer_inboundNATRules 'inbound-nat-rules/main.bicep' = [for (inboundNATRule, index) in inboundNatRules: {
