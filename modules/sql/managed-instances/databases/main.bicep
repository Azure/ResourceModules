...
module database_backupShortTermRetentionPolicy 'backup-short-term-retention-policies/main.bicep' = if (!empty(backupShortTermRetentionPoliciesObj)) {
...
module database_backupLongTermRetentionPolicy 'backup-long-term-retention-policies/main.bicep' = if (!empty(backupLongTermRetentionPoliciesObj)) {
