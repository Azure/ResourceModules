...
module roleDefinition_mg 'managementGroup/main.bicep' = if (empty(subscriptionId) && empty(resourceGroupName)) {
...
module roleDefinition_rg 'resourceGroup/main.bicep' = if (!empty(resourceGroupName) && !empty(subscriptionId)) {
