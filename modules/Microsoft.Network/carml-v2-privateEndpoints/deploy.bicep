...
// Children
type privateDnsZoneGroupObj = {
  privateDNSResourceIds?: string[]
}
...
param privateDnsZoneGroup privateDnsZoneGroupObj = {}
...
output location string = privateEndpoint.outputs.location
