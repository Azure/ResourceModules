# Authorization Locks on Resource Group scope `[Microsoft.Authorization/locks/resourceGroup]`

This module deploys an Authorization Lock on a Resource Group scope.
