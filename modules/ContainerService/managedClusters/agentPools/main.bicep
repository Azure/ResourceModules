...
resource managedCluster 'Microsoft.ContainerService/managedClusters@2023-03-01' existing = {
  name: managedClusterName
}

resource agentPool 'Microsoft.ContainerService/managedClusters/agentPools@2023-03-01' = {
  name: name
