...
module images './Microsoft.Compute/images/deploy.bicep' = {
  ...
  params: {
    ...
    osDiskBlobUri: 'https://adp<<namePrefix>>azsax001.blob.core.windows.net/vhds/adp-<<namePrefix>>-az-imgt-vhd-001.vhd'
...
```json
{
  ...
  "parameters": {
    ...
    "osDiskBlobUri": {
      "value": "https://adp<<namePrefix>>azsax001.blob.core.windows.net/vhds/adp-<<namePrefix>>-az-imgt-vhd-001.vhd"
    },
    "osDiskCaching": {
      "value": "ReadWrite"
    },
